    ...
    programs: [
      {
        ...
        status: "recruiting",
        slug: "camp",
        ctaUrl: "https://ainativecamp-production.up.railway.app/",
        ctaLabel: { ko: "알아보기", en: "Learn More" },
      },
      {
        id: "camp-harness",
        name: { ko: "AI Native Camp: Harness", en: "AI Native Camp: Harness" },
        subtitle: { ko: "심화 과정 (1→10)", en: "Advanced (1→10)" },
        copy: {
          ko: "AI 도구 사용을 넘어, 나만의 AI 시스템(하네스)을 설계하고 프로덕트를 만드는 심화 과정입니다",
          en: "Go beyond using AI tools — design your own AI system (harness) and build real products",
        },
        status: "recruiting",
        slug: "camp-harness",
        ctaUrl: "https://forms.fillout.com/t/7FAQ3iQzgAus",
      ...
      },
      {
        ...
        status: "recruiting",
        slug: "camp-finance",
        ctaUrl: "https://ainativecamp-finance-production.up.railway.app/",
        ctaLabel: { ko: "알아보기", en: "Learn More" },
      },
    ],
  },
    ...
    programs: [
      {
        ...
        status: "recruiting",
        slug: "compounder",
        ctaUrl: "https://forms.fillout.com/t/qVC2756rugus",
        ctaLabel: { ko: "알아보기", en: "Learn More" },
      },
      {
    ...
    programs: [
      {
        ...
        status: "recruiting",
        slug: "ax",
        ctaUrl: "https://forms.fillout.com/t/93X8wXvENqus",
        ctaLabel: { ko: "지원하기", en: "Apply" },
      },
      {
        id: "gtm",
        ...
        status: "recruiting",
        slug: "gtm",
        ctaUrl: "https://forms.fillout.com/t/ipW4Po8CsEus",
        ctaLabel: { ko: "지원하기", en: "Apply" },
      },
      {
        id: "pmf",
        ...
        status: "recruiting",
        slug: "pmf",
        ctaUrl: "https://forms.fillout.com/t/3kiSirWVFyus",
        ctaLabel: { ko: "지원하기", en: "Apply" },
      },
    ],
  },
