        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-8 mb-12">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <nav className="flex flex-col gap-3 text-sm">
              <Link
                href={`/${lang}#about`}
                className="text-ds-text-muted hover:text-ds-primary transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ds-accent"
              >
                {t.nav.about}
              </Link>
              <Link
