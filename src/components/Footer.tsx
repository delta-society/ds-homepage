      ...
      <div className="max-w-[var(--container-max)] mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/60 text-sm max-w-md leading-relaxed">
              Where Outliers Connect & Build.
              <br />
              변화의 최전선에 있는 사람들이 모여 지식을 나누고 함께 만드는
              커뮤니티.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                disabled
                className="bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-sm text-white placeholder:text-white/40 flex-1 opacity-50 cursor-not-allowed"
              />
              <button
                type="button"
                disabled
                className="bg-ds-accent/50 text-ds-primary px-4 py-2 text-sm font-semibold rounded-lg cursor-not-allowed shrink-0"
              >
                Coming Soon
              </button>
            </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              href="https://youtube.com/@deltasociety"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/40 hover:text-ds-accent transition-colors"
              aria-label="YouTube"
